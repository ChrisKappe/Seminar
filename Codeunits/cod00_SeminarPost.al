codeunit 50100 "CSD Seminar-Post"
{
    ...
    trigger OnRun();
    begin
        OnBeforePostSeminarRegistration(Rec);
        ...
        with SeminarRegHeader do begin
            ...
            if SeminarRegLine.FindSet then begin
                repeat
                    ...
                    OnBeforePostSeminarRegLine(SeminarRegLine);
                    // Post seminar entry 
                ...
                OnAfterPostSeminarRegistration(Rec);
                Delete(true);
            end;
    ...
    local procedure OnBeforePostSeminarRegistration(var SeminarRegHeader: Record "CSD Seminar Reg. Header")
    begin
    end;

    [IntegrationEvent(true, true)]
    local procedure OnAfterPostSeminarRegistration(var SeminarRegHeader: Record "CSD Seminar Reg. Header")
    begin
    end;

    [IntegrationEvent(true, true)]
    local procedure OnBeforePostSeminarRegLine(var SeminarRegLine: Record "CSD Seminar Registration Line")
    begin
    end;
}
